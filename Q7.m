function [] = Q7()
    ...
    for i = 1:7
        ...
        trajectory_matrix = trajectory_planner(7, waypoints, max_iter, waypoint_times, time_step);
    ...
    subplot(1,2,1);
    for h = 1:7     
        plot(time_vec, des_accelerationMatrix(h,:));
        hold on;
    end
    xlabel('acceleration');
    ylabel('time');
    ylim([0 3])
    legendCell = {'rise in 10s', 'rise in 8s', 'rise in 5s', 'rise in 4s', 'rise in 3s', 'rise in 2s', 'rise in 1s'};
    legend(legendCell)
